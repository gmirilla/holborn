...
<form action="/newcert/createstep1" method="post">
    ...
    <div class="form-group">
        ...
        text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value={{$cci->year}} data-input name="date">
    ...
    <div class="form-group">
        ...
        text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" id="taskinvoicedate"  name="invoice_date">
    </div>
    <div class="form-group">
